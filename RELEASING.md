# Releasing the Agents SDK Python harness

This repository publishes the public `tinyhat/harnesses/agents-sdk-python`
...
gh release create "$TAG" \
  --repo tinyloophub/tinyhat--harnesses--agents-sdk-python \
  --title "$TAG" \
  --latest \
  --verify-tag \
